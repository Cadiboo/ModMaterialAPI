...
public final class ModReference {
	...
	public static final String MOD_NAME = "ModMaterial API";

	/** This is our Mod's Mod Id that is used for stuff like resource locations. */
	public static final String MOD_ID = "modmaterialapi";
	...
	public static final String	DEPENDENCIES		= "required-after:minecraft;" + "required-after:forge;" + "";
